...
export default function StrategicRoadmapPage() {
    return (
        <div className="animate-in fade-in duration-500 w-full max-w-5xl mx-auto pb-20">
            <DocHeader
                breadcrumb={<>01. Strategy & Market <span className="opacity-30 mx-1">›</span> <span className="text-involve-blue">Strategic Roadmap 2025–2030: Building Europe’s Earth Intelligence Platform</span></>}
                title="Strategic Roadmap 2025–2030: Building Europe’s Earth Intelligence Platform"
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">Strategic Vision</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">Europe’s geospatial intelligence capabilities today are <strong>fragmented and heavily reliant on non-European systems</strong>[1][2]. Involve’s long-term ambition is to unify this ecosystem into a sovereign European Earth Intelligence platform. The vision is a system delivering <strong>persistent, multi-domain sensing</strong> (stratospheric balloons, satellites, drones and ground sensors) combined with <strong>AI-driven analytics and decision-support</strong> tools for governments and enterprises. It embodies Europe’s drive for digital sovereignty and resilience. This aligns with EU initiatives like the EURO-3C project, which explicitly aims for a <i>“federated secure and sovereign model”</i> of cloud and AI infrastructure[3]. Involve provides the sensing and GeoAI layers for this vision.</p>
