...
<ul className="list-disc pl-6 mb-6 text-involve-muted">
  ...
  <li className="mb-2 text-[15px] font-light leading-relaxed"><strong>Vertical SaaS and Data-as-a-Service:</strong> In sectors like energy and infrastructure, companies increasingly subscribe to monitoring platforms. Example: pipeline monitoring firms (e.g. LiveEO) charge monthly/annual fees per km of pipeline. We will similarly price based on the scale of assets under surveillance and the frequency of analysis. By owning the sensing layer ourselves, we internalize more margin than companies that only resell satellite data.</li>
      ...
      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[1] BlackSky Technology Inc. - BlackSky Wins New Strategic International Customer for Subscription-Based Gen-2 Imagery and Analytics Services</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://ir.blacksky.com/news-events/press-releases/news-details/2025/BlackSky-Wins-New-Strategic-International-Customer-for-Subscription-Based-Gen-2-Imagery-and-Analytics-Services-02-18-2025/default.aspx</p>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[2] BlackSky Technology Inc. - BlackSky Signs New Eight-Figure International Contract for Accelerated Delivery of Gen-3 Sovereign Space-Based Intelligence Solution</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://ir.blacksky.com/news-events/press-releases/news-details/2026/BlackSky-Signs-New-Eight-Figure-International-Contract-for-Accelerated-Delivery-of-Gen-3-Sovereign-Space-Based-Intelligence-Solution/default.aspx</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[3] Earth Engine Pricing  |  Google Cloud</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://cloud.google.com/earth-engine/pricing</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[4] Data flywheel: What it is and how it works | NVIDIA Glossary</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.nvidia.com/en-us/glossary/data-flywheel/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[5] Space economy is unlocking data-driven business growth: PwC</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.pwc.com/us/en/industries/industrial-products/library/space-economy-data-driven-business-growth.html</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[6] A Typical Gross Profit Margin for a SaaS Business | Finro</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.finrofca.com/startup-qa/a-typical-gross-profit-margin-for-a-saas-business</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[7] NRO finalizes imagery contract worth 'billions of dollars'</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.nextgov.com/acquisition/2022/05/nro-finalizes-imagery-contract-worth-billions-dollars/367467/</p>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[8] Affordability Is Transforming the Satellite Industry: How Each Segment Is Keeping Up with the Pace of Change</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.kratosspace.com/constellations/articles/affordability-is-transforming-the-satellite-industry</p>
