...
- <strong>Others:</strong> Aalyria (EU) and companies like Peraton (U.S.) target high-throughput communications (O-RAN, 5G) from balloons/drones. These HAPS variants emphasize connectivity rather than imagery, but they represent the same near-space domain.</p>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">Collectively, the stratospheric layer bridges satellites and aviation. Compared to satellites, HAPS/balloons offer <strong>continuous local persistence</strong> (hours to months of dwell time[4]) and flexible tasking. Compared to drones/planes, they offer far longer endurance with no pilots. Each approach has tradeoffs in altitude (20–25 km vs. 0.1–1 km), coverage (hundreds of km vs 10s km), resolution (0.1–1 m vs a few cm), and cost (~$0.1–1M per platform vs $10k–$100k drones). Notably, high-altitude balloons are <strong>orders of magnitude cheaper</strong> than equivalent satellites[8], though achieving true network-level coverage would require many of them.</p>
...
<div className="overflow-x-auto my-8 border border-involve-border bg-involve-panel"><table className="w-full text-left border-collapse">
  <tbody>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Altitude</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Coverage</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Persistence</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Spatial Resolution</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Tasking Latency</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Cost (per unit)</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>High:</strong> $5–300M (large sat)</p>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Low:</strong> $5k–$500k</p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Very Low:</strong> ~€30k per platform (balloon architecture)</p>
...
<div className="overflow-x-auto my-8 border border-involve-border bg-involve-panel"><table className="w-full text-left border-collapse">
  <tbody>
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Company</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Infra Owned</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Persistent Sensing</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>AI Analytics</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Multi-Domain Data</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Real-Time Tasking</strong></p>

      </td>
      <td className="border border-involve-border px-4 py-3 text-[13px] font-light text-involve-text align-top">
        
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Decision Outputs</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Involve (us)</strong></p>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>High</strong> (days–weeks)</p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Planet Labs</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>ICEYE</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>BlackSky</strong></p>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">High (up to 15/day)[1]</h2>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Sceye</strong></p>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">High (months–year)[2]</h2>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Urban Sky</strong></p>
      ...
      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">High (days/weeks)[5]</h2>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Near Space Labs</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Orbital Insight</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Descartes Labs</strong></p>
    ...
    <tr>
      ...
      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6"><strong>Palantir</strong></p>
      ...
      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[4][11] <i>Figure: Competitive positioning of select companies in Earth Intelligence. Involve integrates “infra” (sensors) with “intel” (AI/decision), whereas most others specialize in one domain.</i><i></i></p>
...
<ul className="list-disc pl-6 mb-6 text-involve-muted">
  <li className="mb-2 text-[15px] font-light leading-relaxed">BlackSky Technologies, <i>Press Release</i> (Dec 13, 2021): “BlackSky achieves world’s highest revisit… Satellite Constellation with 15 revisits/day”[1][13].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">World View Enterprises, <i>Press Release</i> (Dec 17, 2024): “World View Validates Next-Generation Balloon… [providing] superior imaging resolution and unparalleled persistence for up to 30 days”[4].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">Sceye Inc., <i>Platform Overview</i> (2025): “Sceye’s HAPS… stay airborne… for months to a year… remain within an area of operation”[2].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">Insurance Innovation Reporter, <i>“Near Space Labs Targets Underwriting Blind Spots”</i> (Mar 5, 2026): Near Space Labs’ balloons deliver <strong>7 cm resolution</strong> imagery (twice-yearly cadences)[7].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">John F. Schank et al., <i>“Mind the Gap: Space Resiliency Advantages of High-Altitude Capabilities,”</i> Joint Force Quarterly (Issue 109): HAPS cost <strong>~$100k</strong> vs ~$2M per smallsat[8].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">Zsolt Pataki et al., <i>EU Space Strategy for Security &amp; Defence</i> (EU Parliament, Aug 2023): Highlights need for EU dual-use space services and autonomy[12][9].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">DataWalk, <i>“Modernizing Intelligence Operations: Why European Agencies…”</i> (Nov 13, 2025): European agencies see dependence on US platforms (Palantir/i2) as a vulnerability and seek sovereign alternatives[10][11].</li>
  <li className="mb-2 text-[15px] font-light leading-relaxed">Chad Anderson (Space Capital), <i>Big Ideas 2023 Podcast</i> (July 2023): Reports <strong>Earth intelligence market growth</strong> and Planet Labs’ record revenues (FY2023: $191M, +64% YoY)[14] (for context on demand).</li>
</ul>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[1] [13] BlackSky achieves world’s highest revisit, time-diverse dawn-to-dusk satellite constellation with three successful launches in three weeks - BlackSky</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://blacksky.com/press-releases/blacksky-achieves-worlds-highest-revisit-time-diverse-dawn-to-dusk-satellite-constellation-with-three-successful-launches-in-three-weeks/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[2] Platform - Sceye</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://sceye.com/platform/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[3] Stratobus: Autonomous surveillance and telecoms 20km above Earth | EUROCONTROL</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.eurocontrol.int/article/stratobus-autonomous-surveillance-and-telecoms-20km-above-earth</p>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[4] World View Validates Next-Generation Balloon Design, Strengthens Market Leadership in Stratospheric Remote Sensing</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.worldview.space/stories/world-view-validates-next-generation-balloon-design-strengthens-market-leadership-in-stratospheric-remote-sensing</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[5] [6] Urban Sky | Pioneering the Stratosphere</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://urbansky.com/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[7] Near Space Labs Targets Underwriting Blind Spots | Insurance Innovation Reporter</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://iireporter.com/near-space-labs-scales-stratospheric-imagery-for-insurance/</p>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[8] Mind the Gap: Space Resiliency Advantages of High-Altitude Capabilities &gt; National Defense University Press &gt; Article</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://ndupress.ndu.edu/Joint-Force-Quarterly/Joint-Force-Quarterly-109/Article/Article/3379976/mind-the-gap-space-resiliency-advantages-of-high-altitude-capabilities/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[9] [12] First EU space strategy for security and defence</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.europarl.europa.eu/RegData/etudes/ATAG/2023/747448/EPRS_ATA(2023)747448_EN.pdf</p>


      <p className="text-[12px] font-light text-involve-muted leading-relaxed mb-3">[10] [11] Sovereign Intelligence: The European Alternative to US Platforms like Palantir &amp; i2</p>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://datawalk.com/modernizing-intelligence-operations-why-european-agencies-are-choosing-agile-sovereign-alternatives-to-us-platforms/</p>


      <h2 className="text-xl md:text-2xl font-semibold text-involve-text tracking-tight mb-4 mt-12 border-b border-involve-border pb-2">[14] Big Ideas 2023 | The Space Capital Podcast</h2>


      <p className="text-[15px] font-light text-involve-muted leading-relaxed mb-6">https://www.spacecapital.com/podcasts/big-ideas-2023</p>
